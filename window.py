...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.lblTitulo.setGeometry(QtCore.QRect(440, 330, 231, 20))
        self.lblTitulo.setObjectName("lblTitulo")
        self.widget = QtWidgets.QWidget(self.centralwidget)
        self.widget.setGeometry(QtCore.QRect(430, 370, 237, 93))
        ...
        self.gridLayout.addWidget(self.btnSalir, 4, 2, 1, 1)
        self.btnAceptar = QtWidgets.QPushButton(self.widget)
        self.btnAceptar.setObjectName("btnAceptar")
        self.gridLayout.addWidget(self.btnAceptar, 4, 0, 1, 1)
        self.txtDatos = QtWidgets.QLineEdit(self.widget)
        self.txtDatos.setObjectName("txtDatos")
        self.gridLayout.addWidget(self.txtDatos, 0, 1, 1, 1)
        MainWindow.setCentralWidget(self.centralwidget)
        self.menubar = QtWidgets.QMenuBar(MainWindow)
        self.menubar.setGeometry(QtCore.QRect(0, 0, 1133, 27))
